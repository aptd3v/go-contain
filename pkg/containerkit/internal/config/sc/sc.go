...
import (
	...
	"github.com/aptd3v/containerkit/pkg/containerkit/internal/config/sc/build"
	"github.com/aptd3v/containerkit/pkg/containerkit/internal/config/sc/deploy"
	"github.com/aptd3v/containerkit/pkg/containerkit/internal/config/sc/secrets/secretservice"
...
func WithNoAttach() func(*types.ServiceConfig) error {
	attach := false
...
func WithAnnotation(key, value string) func(*types.ServiceConfig) error {
	return func(config *types.ServiceConfig) error {
...
func WithDevelop(action WatchAction, watchPath string, target string, ignorePaths ...string) func(*types.ServiceConfig) error {
	return func(config *types.ServiceConfig) error {
...
func WithDependsOn(service string) func(*types.ServiceConfig) error {
	return func(config *types.ServiceConfig) error {
...
// parameters:
//   - service: the service to depend on
func WithDependsOnHealthy(service string) func(*types.ServiceConfig) error {
	return func(config *types.ServiceConfig) error {
		if config.DependsOn == nil {
			config.DependsOn = make(types.DependsOnConfig, 0)
		}
...
func WithEnvFile(path string) func(*types.ServiceConfig) error {
	return func(config *types.ServiceConfig) error {
...
func WithDeploy(setters ...deploy.SetDeployConfig) func(*types.ServiceConfig) error {
	return func(config *types.ServiceConfig) error {
		if len(setters) == 0 {
			return nil
		}
...
func WithProfiles(profiles ...string) func(*types.ServiceConfig) error {
	return func(config *types.ServiceConfig) error {
...
func WithBuild(setters ...build.SetBuildConfig) func(*types.ServiceConfig) error {
	return func(config *types.ServiceConfig) error {
		if len(setters) == 0 {
			return nil
		}
...
func WithSecret(setters ...secretservice.SetSecretServiceConfig) func(*types.ServiceConfig) error {
	return func(config *types.ServiceConfig) error {
		if len(setters) == 0 {
			return nil
		}
...
func Fail(err error) func(*types.ServiceConfig) error {
	return func(config *types.ServiceConfig) error {
...
// note: this is useful for when you want to fail the service config
// and append the error to the service config error collection
func Failf(stringFormat string, args ...any) func(*types.ServiceConfig) error {
	return func(config *types.ServiceConfig) error {
