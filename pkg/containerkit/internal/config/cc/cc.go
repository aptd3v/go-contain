...
func WithEnv(key string, value string) func(*container.Config) error {
...
func WithEnvMap(env map[string]string) func(*container.Config) error {
	return func(config *container.Config) error {
		if config.Env == nil {
			config.Env = make([]string, 0)
		}
...
func WithExposedPort(protocol string, port string) func(*container.Config) error {
	return func(config *container.Config) error {
...
func WithHostName(hostname string) func(*container.Config) error {
	return func(config *container.Config) error {
		if hostname == "" {
...
func WithDomainName(domainname string) func(*container.Config) error {
	return func(config *container.Config) error {
		if domainname == "" {
...
func WithImage(image string) func(*container.Config) error {
	return func(config *container.Config) error {
		if image == "" {
...
func WithImagef(stringFormat string, args ...any) func(*container.Config) error {
	return func(config *container.Config) error {
...
func WithCommand(cmd ...string) func(*container.Config) error {
	return func(config *container.Config) error {
		if len(cmd) == 0 {
...
func WithUser(user string) func(*container.Config) error {
	return func(config *container.Config) error {
		if user == "" {
...
func WithAttachedStdin() func(*container.Config) error {
	return func(config *container.Config) error {
...
func WithAttachedStdout() func(*container.Config) error {
	return func(config *container.Config) error {
...
func WithAttachedStderr() func(*container.Config) error {
	return func(config *container.Config) error {
...
func WithTty() func(*container.Config) error {
	return func(config *container.Config) error {
		config.Tty = true
		return nil
	}
...
func WithStdinOpen() func(*container.Config) error {
	return func(config *container.Config) error {
...
func WithStdinOnce() func(*container.Config) error {
	return func(config *container.Config) error {
...
func WithEscapedArgs() func(*container.Config) error {
	return func(config *container.Config) error {
...
func WithVolume(volume string) func(*container.Config) error {
	return func(config *container.Config) error {
		if volume == "" {
...
func WithWorkingDir(dir string) func(*container.Config) error {
	return func(config *container.Config) error {
		if dir == "" {
...
func WithDisabledNetwork() func(*container.Config) error {
	return func(config *container.Config) error {
...
func WithOnBuild(args ...string) func(*container.Config) error {
	return func(config *container.Config) error {
		if len(args) == 0 {
...
//   - label: label key
//   - value: label value
func WithLabel(label, value string) func(*container.Config) error {
...
func WithStopSignal(signal string) func(*container.Config) error {
	return func(config *container.Config) error {
		if signal == "" {
...
func WithEntrypoint(entrypoint ...string) func(*container.Config) error {
	return func(config *container.Config) error {
		if len(entrypoint) == 0 {
...
func WithShell(shell ...string) func(*container.Config) error {
	return func(config *container.Config) error {
		if len(shell) == 0 {
...
func WithStopTimeout(timeout int) func(*container.Config) error {
	return func(config *container.Config) error {
		if timeout <= 0 {
...
func WithMacAddress(macAddress string) func(*container.Config) error {
	return func(config *container.Config) error {
		if macAddress == "" {
...
func Fail(err error) func(*container.Config) error {
	return func(config *container.Config) error {
...
// note: this is useful for when you want to fail the container config
// and append the error to the container config error collection
func Failf(stringFormat string, args ...any) func(*container.Config) error {
	return func(config *container.Config) error {
