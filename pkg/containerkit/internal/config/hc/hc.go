...
func WithMountPoint(setters ...mount.SetMountConfig) func(*container.HostConfig) error {
...
func WithMemoryLimit[T int | string](memory T) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithRestartAlways() func(*container.HostConfig) error {
...
func WithAutoRemove() func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		opt.AutoRemove = true
		return nil
	}
...
func WithPortBindings(protocol, hostIP, hostPort, containerPort string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithDNSLookups(dns ...string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		if opt.DNS == nil {
...
func WithDNSOptions(dnsOption ...string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithDNSSearches(search ...string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithExtraHost(extraHosts ...string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithAddedGroups(group ...string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		if opt.GroupAdd == nil {
...
func WithVolumeBinds(binds ...string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		if opt.Binds == nil {
...
func WithUTSMode(mode string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		if mode == "" {
...
func WithUserNSMode(mode string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		if mode == "" {
...
func WithShmSize[T int | string](size T) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithRuntime(runtime string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		opt.Runtime = runtime
		return nil
	}
...
func WithConsoleSize(height uint, width uint) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithIsolation(isolation string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		switch isolation {
...
func WithCPUCount(count int64) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		if count < 1 {
...
func WithReadonlyPaths(paths ...string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
//
// Returns an error if any path is empty or not absolute.
func WithMaskedPaths(paths ...string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		for _, path := range paths {
			if strings.TrimSpace(path) == "" {
...
func WithNetworkMode(mode string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		mode = strings.TrimSpace(mode)
		if mode == "" ||
			mode == "bridge" ||
...
func WithVolumeDriver(driver string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithVolumesFrom(from string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithIpcMode(mode string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithCgroup(cgroup string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithOomScoreAdj(score int) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithOomKillDisable() func(*container.HostConfig) error {
	oomKillDisable := true
	return func(opt *container.HostConfig) error {
...
func WithPidMode(mode string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithPublishAllPorts() func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithReadOnlyRootfs() func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithSecurityOpts(opts ...string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithStorageOpt(key, value string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithTmpfs(key, value string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		if opt.Tmpfs == nil {
...
func WithPrivileged() func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		opt.Privileged = true
		return nil
	}
...
func WithAddedDevice(device string, pathInContainer string, permissions string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithContainerIDFile(path string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		if strings.TrimSpace(path) == "" {
...
func WithCPUShares(shares int64) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		if shares <= 0 {
...
func WithCPUPeriod[T int | string](period T) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		var micros int64
...
func WithCPUPercent(percent int64) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		if percent < 0 {
...
func WithCPUQuota[T int | string](quotaInput T) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		var quota int64
...
func WithCpusetCpus(cpus string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		if cpus == "" {
...
//
// note: the memory limit can be specified as an integer in bytes or as a string with a unit (e.g. "100M", "1G")
func WithMemoryReservation[T int | string](memory T) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		switch v := any(memory).(type) {
		case int:
...
//
// note: the memory limit can be specified as an integer in bytes or as a string with a unit (e.g. "100M", "1G")
func WithMemorySwap[T int | string](memorySwap T) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithUlimits(name string, soft, hard int64) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		if name == "" {
...
func WithInit() func(*container.HostConfig) error {
	init := true
	return func(opt *container.HostConfig) error {
		opt.Init = &init
		return nil
...
//
// Valid values range from 1,000 to 1,000,000 microseconds (1ms to 1s), inclusive.
func WithCPURealtimePeriod[T int | string](period T) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		switch v := any(period).(type) {
		case int:
...
func WithCPURealtimeRuntime(runtime int64) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		if runtime < -1 {
...
func WithCpusetMems(mems string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		if mems == "" {
...
func WithMemorySwappiness(swappiness int64) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithKernelMemory[T int | string](memory T) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		switch v := any(memory).(type) {
		case int:
...
func WithPidsLimit(limit int64) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		if limit < -1 || limit == 0 {
...
func WithBlkioWeight(weight uint16) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithBlkioDeviceReadBps[T int | string](devicePath string, rate T) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
//
// Returns an error if the string rate cannot be parsed.
func WithBlkioDeviceWriteBps[T int | string](devicePath string, rate T) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
//
// Returns an error if the string rate cannot be parsed.
func WithBlkioDeviceReadIOps(devicePath string, rate uint64) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
//
// Returns an error if the string rate cannot be parsed.
func WithBlkioDeviceWriteIOps(devicePath string, rate uint64) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithSysctls(key, value string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		if opt.Sysctls == nil {
...
func WithDeviceCgroupRules(rules ...string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithCgroupParent(parent string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithDeviceRequest(driver string, count int, deviceIDs []string, capabilities [][]string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func WithLogDriver(driver string, options map[string]string) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
func Fail(err error) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
...
// note: this is useful for when you want to fail the host config
// and append the error to the host config error collection
func Failf(stringFormat string, args ...any) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
