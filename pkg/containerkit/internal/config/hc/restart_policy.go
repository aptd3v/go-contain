...
func WithRestartPolicy(mode RestartPolicy, maxRetryCount int) func(*container.HostConfig) error {
...
func WithRestartPolicyAlways() func(*container.HostConfig) error {
...
// parameters:
//   - maxRetryCount: the maximum number of retries before giving up
func WithRestartPolicyOnFailure(maxRetryCount int) func(*container.HostConfig) error {
...
func WithRestartPolicyUnlessStopped() func(*container.HostConfig) error {
	return WithRestartPolicy(RestartPolicyUnlessStopped, 0)
}

// WithRestartPolicyNever sets the restart policy to no
func WithRestartPolicyNever() func(*container.HostConfig) error {
