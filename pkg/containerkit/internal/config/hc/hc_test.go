...
func TestAssignments(t *testing.T) {
	tests := []struct {
		...
		setFn    func(*container.HostConfig) error
		field    string
		wantErr  bool
		message  string
		expected any
		...
		{
			config:   &container.HostConfig{},
			setFn:    hc.WithVolumeBinds("./volumes/storage:/var/lib/storage:z"),
			field:    "Binds",
			wantErr:  false,
			message:  "WithVolumeBinds SELinux z ok",
			expected: []string{"./volumes/storage:/var/lib/storage:z"},
		},
		{
			config:   &container.HostConfig{},
			setFn:    hc.WithVolumeBinds("/host/data:/data:Z"),
			field:    "Binds",
			wantErr:  false,
			message:  "WithVolumeBinds SELinux Z ok",
			expected: []string{"/host/data:/data:Z"},
		},
		{
			config:   &container.HostConfig{},
			setFn:    hc.WithVolumeBinds("/etc/vector/vector.yml:/etc/vector/vector.yml:ro,z"),
			field:    "Binds",
			wantErr:  false,
			message:  "WithVolumeBinds combined ro,z ok",
			expected: []string{"/etc/vector/vector.yml:/etc/vector/vector.yml:ro,z"},
		},
		{
			config:   &container.HostConfig{},
			setFn:    hc.WithVolumeBinds("/host/path:/container:readonly"),
			field:    "Binds",
			wantErr:  false,
			message:  "WithVolumeBinds readonly ok",
			expected: []string{"/host/path:/container:readonly"},
		},
		{
			config:   &container.HostConfig{},
			setFn:    hc.WithVolumeBinds("/app/data:/data:ro,cached"),
			field:    "Binds",
			wantErr:  false,
			message:  "WithVolumeBinds ro,cached ok",
			expected: []string{"/app/data:/data:ro,cached"},
		},
		{
			config:   &container.HostConfig{},
			setFn:    hc.WithVolumeBinds("C:\\data:/app:ro"),
			field:    "Binds",
			wantErr:  false,
			message:  "WithVolumeBinds path with colon ok",
			expected: []string{"C:\\data:/app:ro"},
		},
		{
			config:   &container.HostConfig{},
