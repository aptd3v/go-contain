...
func WithAddedCapabilities(caps ...Capability) func(*container.HostConfig) error {
...
func WithDroppedCapabilities(caps ...Capability) func(*container.HostConfig) error {
	return func(opt *container.HostConfig) error {
		if opt.CapDrop == nil {
...
func WithDroppedAllCapabilities() func(*container.HostConfig) error {
...
func WithDroppedSensitiveCapabilities() func(*container.HostConfig) error {
