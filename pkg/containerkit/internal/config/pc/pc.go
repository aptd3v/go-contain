...
func WithArchitecture(architecture string) func(*ocispec.Platform) error {
...
func WithOS(OS string) func(*ocispec.Platform) error {
	return func(options *ocispec.Platform) error {
		options.OS = OS
		return nil
	}
...
func WithOSVersion(OSVersion string) func(*ocispec.Platform) error {
	return func(options *ocispec.Platform) error {
...
func WithOSFeatures(OSFeatures ...string) func(*ocispec.Platform) error {
	return func(options *ocispec.Platform) error {
...
func WithVariant(variant string) func(*ocispec.Platform) error {
	return func(options *ocispec.Platform) error {
...
func Fail(err error) func(*ocispec.Platform) error {
	return func(options *ocispec.Platform) error {
...
// note: this is useful for when you want to fail the platform config
// and append the error to the platform config error collection
func Failf(stringFormat string, args ...any) func(*ocispec.Platform) error {
	return func(options *ocispec.Platform) error {
