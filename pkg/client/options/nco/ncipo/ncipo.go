// package ncipo provides options for the network IPAM.
package ncipo

import (
	"github.com/aptd3v/go-contain/pkg/client/options/nco/ncipo/ncipc"
...
func WithIpamConfig(setters ...ncipc.SetIPAMConfig) SetIPAMOption {
	return func(o *network.IPAM) error {
		if o.Config == nil {
